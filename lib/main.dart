...
class MyAppState extends State<MyApp> {
  ...
  Future<void> setupInteractedMessage() async {
    ...
    if (initialMessage != null) {
      try {
        if (initialMessage.data['click_action_link'] != null && initialMessage.data['click_action_link'].isNotEmpty) {
          print('click_action_link');
          print(initialMessage.data['click_action_link']);
          setState(() {
